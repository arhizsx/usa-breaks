        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="download_link text-center py-5">
                    ...
                    <div>
                        <a href="" class="download_link" class="btn btn-xl btn-primary" style="background: blue; color:white; font-size: 2em; padding-y: 10px; padding-x:20px; border-radius: 10px;">Download File</a>
                    </div>
                </div>
